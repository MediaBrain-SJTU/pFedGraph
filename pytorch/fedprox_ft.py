...
def local_train_fedavg(args, nets_this_round, global_model, train_local_dls, val_local_dls, test_dl, data_distributions, best_val_acc_list, best_test_acc_list, benign_client_list):
    global_model.cuda()
...
for round in range(args.comm_round):          # Federated round loop
    ...
    mean_personalized_acc = local_train_fedavg(args, nets_this_round, global_model, train_local_dls, val_local_dls, test_dl, data_distributions, best_val_acc_list, best_test_acc_list, benign_client_list)
