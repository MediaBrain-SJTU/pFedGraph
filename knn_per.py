...
from knn_per.config import get_args
from knn_per.utils import local_evaluation
...
for round in range(args.comm_round):          # Federated round loop
    ...
    local_train(args, nets_this_round, train_local_dls, val_local_dls, test_dl, data_distributions, best_val_acc_list, best_test_acc_list)
    ...
    mean_personalized_acc = local_evaluation(args, nets_this_round, global_model, train_local_dls, val_local_dls, test_dl, data_distributions, best_val_acc_list, best_test_acc_list, cfg['classes_size'], benign_client_list)
