...
def get_args():
    ...
    parser.add_argument('--num_cls_iterations', type=int, default=80, help='number of local cls iterations')
    parser.add_argument('--num_rep_iterations', type=int, default=400, help='number of local rep iterations')
