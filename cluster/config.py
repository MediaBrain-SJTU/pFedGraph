...
def get_args():
    ...
    parser.add_argument('--eps1', type=float, default=2.0, help='The hyper-parameter to control clustering')
    parser.add_argument('--eps2', type=float, default=2.5, help='The hyper-parameter to control clustering')
    # attack
